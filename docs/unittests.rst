...
data: the first one, :func:`.get_unit_test`, downloads the metadata
for a test, while the second one, :func:`.load_unit_test_data`,
...
.. autofunction:: striptease.get_unit_test

.. autofunction:: striptease.load_unit_test_data
...
.. autoclass:: striptease.UnitTestType

.. autoclass:: striptease.UnitTest

.. autoclass:: striptease.UnitTestDC
   :members:

.. autoclass:: striptease.UnitTestTimestream
   :members:
...
There are a few other functions implemented by the framework that you
might find useful, e.g., when you are producing a report and want to
put links to a unit test you used in your calculations.

.. autofunction:: striptease.unit_test_url

.. autofunction:: striptease.unit_test_json_url

.. autofunction:: striptease.unit_test_download_url
