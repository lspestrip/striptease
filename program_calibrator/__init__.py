...
class Motor(object):
    ...
    def init(self,counters=True,usr_out=True): # command I
        ...
        if counters and usr_out:
            ...
            raise RuntimeError("at least one of 'counters' or 'usr_out' must be set to True")
        return self.send(cmd)
    ...
    def slew_speed(self,speed): # command T
        ...
        if speed < 10 or speed > 6000:
            raise RuntimeError("slew speed must be beteween 10 and 6000 steps per second")
    ...
    def set_ramp(self,start_stop,slew,ramp_steps):
        ...
        if start_stop < 10 or start_stop > 6000:
            raise RuntimeError("start_stop speed must be beteween 10 and 6000 steps per second")
